...
export default function ModernSix(){
    return(
        <>
        ...
        <ModernPortfolio gridClass="row g-3 row-cols-lg-6 row-cols-md-3 row-cols-sm-2 row-cols-1" col="col-lg-12" containerClass={true}/>
        <FooterTwo/>
        <ScrollTop/>
        </>
    )
