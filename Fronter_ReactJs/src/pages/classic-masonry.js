...
export default function ClassicMasonry(){
                        ...
                        <Masonry>
                            {filteredData.map((item,index) => {
                                ...
                                <div className="picture-item p-2" key={index}>
                                    <div className="card border-0 portfolio portfolio-primary portfolio-classic" key={index}>
                                        <div className="card-body p-0">
                                            <Link to="#" onClick={() => handleImageClick(index)}><img src={item.image} className="img-fluid rounded work-image" alt=""/></Link>
                                            <div className="pt-3">
