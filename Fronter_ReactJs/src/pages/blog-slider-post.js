...
export default function BlogSliderPost(){
    ...
    const sliderImage = [slider1,slider2,slider3]
    return(
        <>
                    ...
                    <div className="row mt-5 justify-content-center">
                        <div className="col-12">
                            <div className="title-heading text-center">
                                ...
                                <h5 className="heading fw-semibold mb-0 sub-heading text-white title-dark mt-4">The Morning After: Uber sets <br/> its sights on Postmates</h5>
                                ...
                                <ul className="list-inline text-center mb-0">
                                    ...
                                    <li className="list-inline-item mx-4 mt-4">
                                        ...
                                        <span className="text-white title-dark">29th Nov 2023</span>
                                    </li>
                        ...
                        <div className="card border-0 shadow rounded overflow-hidden">
                            <TinySlider settings={settings}>
                                {sliderImage.map((item, index) => (
                                    <div className="tiny-slide" key={index}><img src={item} className="rounded-md" alt="" /></div>
                                ))}
                            </TinySlider>
