...
import GridPortfolio from "../componants/gridPortfolio";
...
export default function Gridfive(){
    return(
        ...
        <GridPortfolio gridClass="row g-3 row-cols-lg-5 row-cols-md-3 row-cols-sm-2 row-cols-1" col="col-lg-12" containerClass={true}/>
        <FooterTwo/>
        <ScrollTop/>
        </>
    )
