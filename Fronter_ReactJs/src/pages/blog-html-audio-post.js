...
import audio from "../assets/images/blog/audio.mp3"
...
export default function BlogHtmlAudioPost(){
                            ...
                            <div className="title-heading text-center">
                                ...
                                <ul className="list-inline text-center mb-0">
                                    ...
                                    <li className="list-inline-item mx-4 mt-4">
                                        ...
                                        <span className="text-white title-dark">31st Aug 2023</span>
                                    </li>
                ...
                <div className="row">
                    <div className="col-lg-8 col-md-7">
                        <div className="card border-0 shadow rounded overflow-hidden">
                            <audio controls className="mx-4 mt-4" style={{width:"calc(100% - 48px)"}}>
