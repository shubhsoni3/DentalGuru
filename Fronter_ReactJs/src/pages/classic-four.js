...
export default function ClassicFour(){
    return(
                    ...
                    <div className="position-middle-bottom">
                        <nav aria-label="breadcrumb" className="d-block">
                            <ul className="breadcrumb breadcrumb-muted mb-0 p-0">
                                <li className="breadcrumb-item"><Link to="to">Fronter</Link></li>
        ...
        <ClassicPortfolio gridClass="row g-3 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1" col="col-lg-12"/>
        <FooterTwo/>
        <ScrollTop/>
        </>
    )
