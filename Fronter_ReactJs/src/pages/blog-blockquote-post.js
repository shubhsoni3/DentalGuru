                    ...
                    <div className="row mt-5 justify-content-center">
                        <div className="col-12">
                            <div className="title-heading text-center">
                                <h5 className="heading fw-semibold mb-0 sub-heading text-white title-dark mt-4">Blockquote Post</h5>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-8 col-md-7">
                        <div className="card blog  border-0 shadow rounded overflow-hidden">
                                <div className="bg-soft-primary p-4 rounded shadow">
                                    <div className="position-relative">
                                        <div className="blog-line"></div>
                                        <span className="blog-icon mx-auto rounded-circle bg-white"><i className="mdi mdi-24px mdi-format-quote-open"></i></span>
                                    </div>

                                    <div className="py-4 px-lg-4 my-2">
                                        <p className="text-dark fst-italic h5 mb-0 text-center">“ I'm selfish, impatient and a little insecure. I make mistakes, I am out of control and at times hard to handle. But if you can't handle me at my worst, then you sure as hell don't deserve me at my best. ”</p>
                                        <h6 className="mb-0 mt-3 text-center"> - Marilyn Monroe</h6>
                                    </div>

                                    <div className="position-relative">
                                        <div className="blog-line"></div>
                                        <span className="blog-icon mx-auto rounded-pill bg-white"><i className="mdi mdi-24px mdi-format-quote-close"></i></span>
                                    </div>
                                </div>
