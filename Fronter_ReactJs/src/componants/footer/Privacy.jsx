      ...
      <div className="container mt-5">
        ...
        <div className="mt-5">
          <p className="text-secondary">
            ...
            <br></br>
            <br></br>
            <h5 className="text-black">Interpretation and Definitions </h5>
            <h5 className="text-black"> Interpretation</h5>
            <p>
              {" "}
            ...
            <h5 className="text-black">Definitions</h5>
            ...
            <p>
              ...
              in this Agreement) refers to doaguru.com, Jabalpur, Madhya
              pradesh INDIA 482002.
            </p>
            Company (referred to as either "the Company", "We", "Us" or "Our" in
            this Agreement) refers to doaguru.com, Jabalpur, Madhya
            pradesh INDIA 482002.
            <br></br>
            Cookies are small files that are placed on Your computer, mobile
            device or any other device by a website, containing the details of
            Your browsing history on that website among its many uses. Country
            refers to: Madhya Pradesh, India<br></br>
            Device means any device that can access the Service such as a
            computer, a cellphone or a digital tablet.<br></br>
            Personal Data is any information that relates to an identified or
            identifiable individual.<br></br>
            ...
            (for example, the duration of a page visit).<br></br>
            Website refers to doaguru.com, accessible from
            https://doaguru.com <br></br>
            You means the individual accessing or using the Service, or the
            company, or other legal entity on behalf of which such individual is
            accessing or using the Service, as applicable.<br></br>
            <br></br>
            {/* <h5 className="text-black">
              Collecting and Using Your Personal Data
            </h5>
            <br></br>Types of Data Collected<br></br> <br></br>
            Personal Data<br></br>
            While using Our Service, We may ask You to provide Us with certain
            personally identifiable information that can be used to contact or
            identify You. Personally identifiable information may include, but
            is not limited to:<br></br>
            Email address<br></br>
            ...
            mobile device.<br></br>
            <br></br>
            <h5 className="text-black">Tracking Technologies and Cookies</h5>
            <br></br>
            We use Cookies and similar tracking technologies to track the
            activity on Our Service and store certain information. Tracking
            technologies used are beacons, tags, and scripts to collect and
            track information and to improve and analyze Our Service. The
            technologies We use may include: <br></br>• Cookies or Browser
            ...
            Service may use Cookies. <br></br>• Web Beacons. Certain sections of
            ...
            your preferences every time You use the Website.<br></br>
            <br></br>
            For more information about the cookies we use and your choices
            regarding cookies, please visit our Cookies Policy or the Cookies
            section of our Privacy Policy.<br></br> <br></br>
            {/* <h5 className="text-black">Use of Your Personal Data</h5> <br></br>
            ...
            or reasonable for their implementation. <br></br>
            ...
            Service users is among the assets transferred. <br></br>
            ...
            <br></br> <br></br>• With Service Providers: We may share Your
            personal information with Service Providers to monitor and analyze
            the use of our Service, to contact You. <br></br>• For business
            transfers: We may share or transfer Your personal information in
            connection with, or during negotiations of, any merger, sale of
            Company assets, financing, or acquisition of all or a portion of Our
            business to another company. <br></br>• With Affiliates: We may
            ...
            control with Us. <br></br>• With business partners: We may share
            Your information with Our business partners to offer You certain
            products, services or promotions. <br></br>• With other users: when
            ...
            and may be publicly distributed outside. <br></br>• With Your
            consent: We may disclose Your personal information for any other
            purpose with Your consent. <br></br> <br></br>
            <h5 className="text-black">Retention of Your Personal Data</h5>{" "}
            <br></br>
            ...
            and enforce our legal agreements and policies. <br></br> <br></br>
            The Company will also retain Usage Data for internal analysis
            purposes. Usage Data is generally retained for a shorter period of
            time, except when this data is used to strengthen the security or to
            improve the functionality of Our Service, or We are legally
            obligated to retain this data for longer time periods. <br></br>{" "}
            <br></br> */}
            {/* <h5 className="text-black">Transfer of Your Personal Data</h5>{" "}
            <br></br>
            ...
            information.<br></br>
            <br></br>
            <h5 className="text-black"> Delete Your Personal Data</h5> <br></br>
            You have the right to delete or request that We assist in deleting
            the Personal Data that We have collected about You.<br></br>
            Our Service may give You the ability to delete certain information
            about You from within the Service.<br></br>
            ...
            when we have a legal obligation or lawful basis to do so. <br></br> */}
            {/* <br></br> */}
            {/* <h5 className="text-black">
              Disclosure of Your Personal Data
            </h5>{" "} */}
            <br></br>
            <h5 className="text-black">Business Transactions</h5> <br></br>
            If the Company is involved in a merger, acquisition or asset sale,
            Your Personal Data may be transferred. We will provide notice before
            Your Personal Data is transferred and becomes subject to a different
            Privacy Policy.<br></br> <br></br>
            <h5 className="text-black">Law enforcement</h5> <br></br>
            Under certain circumstances, the Company may be required to disclose
            Your Personal Data if required to do so by law or in response to
            valid requests by public authorities (e.g. a court or a government
            agency).<br></br> <br></br>
            <h5 className="text-black">Other legal requirements</h5> <br></br>
            The Company may disclose Your Personal Data in the good faith belief
            that such action is necessary to:<br></br>
            <br></br>• Comply with a legal obligation<br></br>• Protect and
            defend the rights or property of the Company<br></br>• Prevent or
            investigate possible wrongdoing in connection with the Service
            <br></br>• Protect the personal safety of Users of the Service or
            the public<br></br>• Protect against legal liability<br></br>
            <br></br>
            <h5 className="text-black">Security of Your Personal Data</h5>{" "}
            <br></br>
            ...
            <br></br>
            <h5 className="text-black"> Children's Privacy</h5>
            <br></br>
            ...
            information.<br></br>
            <br></br>
            <h5 className="text-black">Links to Other Websites</h5> <br></br>
            ...
            services.<br></br>
            <br></br>
            <h5 className="text-black">Changes to this Privacy Policy</h5>{" "}
            <br></br>
            ...
            us: <br></br>• Website: <a href="https://doaguru.com/contact_us"> https://doaguru.com/contact_us </a> <br></br>
          </p>
