...
const bookDemo = (req, res) => {
    ...
    db.query(sql, values, (err, data) => {
        ...
        console.log(`[${new Date().toISOString()}] Data Uploaded Successfully: ID ${data.insertId}`);
...
module.exports = {bookDemo, getbookDemo, sendOtpEmail, loginUserWithOTP, verifyOtpAndLogin, contact, getContacts};
