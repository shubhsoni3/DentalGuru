...
const PaymentPage = () => {
  ...
  const makePayment = async (e) => {
    e.preventDefault();
    try {
      if (!userDetails.name || !userDetails.email || !userDetails.phone_number || !userDetails.addresh) {
          ...
          try {
            ...
            if (verifyResponse.data.success) {
              ...
              try {
                ...
                console.error("Error sending payment details to subscription API:", error);
              }
            } else {
